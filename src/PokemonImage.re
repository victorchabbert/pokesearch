...
let make = (_children) => {
  ...
  render: (self) =>
    <figure className={"ps-PokemonCard__picture" ++ (self.state.flip ? " ps-PokemonCard__picture--flipped" : "")}>
      ...
      <div className="ps-PokemonCard__picture-controls">
        <div className="ps-PokemonCard__picture-control">
          ...
          <span onClick={_e => self.send(ToggleShine)} className="ps-label ps-label--black ps-PokemonCard__control-label">
            (se("Shine"))
          </span>
        </div>
        <div className="ps-PokemonCard__picture-control">
          ...
          <span onClick={_e => self.send(ToggleFlip)} className="ps-label ps-label--black ps-PokemonCard__control-label">
            (se("Flip"))
          </span>
        </div>
      </div>

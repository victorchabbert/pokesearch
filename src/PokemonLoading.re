...
let make = (~name, _children) => {
  ...component,
  render: (_self) =>
    <article className="ps-PokemonCard--short ps-PokemonCard ps-PokemonCard--loader">
      <div className="ps-PokemonCard__header">
        <figure className="ps-PokemonCard__picture">
          <div className="ps-PokemonCard__flipper"> <img src="./img/25.png" alt="pikachu" /> </div>
        </figure>
        <header className="ps-PokemonCard__info">
          <h2 className="ps-PokemonCard__name"> (se(name)) </h2>
          <div className="ps-PokemonCard__types">
            <span className="ps-label ps--grey ps-label--fake ps-Pokemonard__type">
              (se("     "))
            </span>
          </div>
          <h3 className="ps-PokemonCard__number"> (se("#000")) </h3>
          <div className="ps-PokemonCard__characteristics">
            <div className="ps-PokemonCard__physiognomy">
              <div className="ps-PokemonCard__physiognomy-item">
                ...
                <p className="ps-PokemonCard__physiognomy-value"> (se("0.0 m")) </p>
              </div>
              <div className="ps-PokemonCard__physiognomy-item">
                ...
                <p className="ps-PokemonCard__physiognomy-value"> (se("0.0 kg")) </p>
              </div>
            </div>

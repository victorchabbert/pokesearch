  ...
  render: (_self) =>
    <article className="ps-PokemonCard">
      ...
      <header className="ps-PokemonCard__info">
        <h2 className="ps-PokemonCard__name">( se( "Pikachu" ) )</h2>
        <div className="ps-PokemonCard__types">
          <span className="ps-label ps-label--yellow ps-Pokemonard__type">( se( "Electric" ) )</span>
        </div>
        <h3 className="ps-PokemonCard__number">( se( "#025" ) )</h3>
        <div className="ps-PokemonCard__characteristics">
          <div className="ps-PokemonCard__physiognomy">
            <div className="ps-PokemonCard__physiognomy-item">
              ...
              <p className="ps-PokemonCard__physiognomy-value">( se( "0.4 m" ) )</p>
            </div>
            <div className="ps-PokemonCard__physiognomy-item">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                <path d="M16 6v2h2l2 12H0L2 8h2V6a6 6 0 1 1 12 0zm-2 0a4 4 0 1 0-8 0v2h8V6zM4 10v2h2v-2H4zm10 0v2h2v-2h-2z"/>
              </svg>
              <p className="ps-PokemonCard__physiognomy-value">( se( "6.0 kg" ) )</p>
            </div>
          </div>
          <div className="ps-PokemonCard__interactions">
            <svg className="ps-PokemonCard__heart" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
              <path d="M10 3.22l-.61-.6a5.5 5.5 0 0 0-7.78 7.77L10 18.78l8.39-8.4a5.5 5.5 0 0 0-7.78-7.77l-.61.61z"/>
            </svg>
            <svg className="ps-PokemonCard__bookmark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
      ...
      <section className="ps-PokemonCard__details">
        ...
        <div className="ps-PokemonCard__tab-scroll">
          ...
          <div className="ps-PokemonCard__ability">
            <h4 className="ps-PokemonCard__ability-title"> (se("Lightning Rod")) <span className="ps-PokemonCard__ability-title--sub">(se("hidden"))</span></h4>
            <p className="ps-PokemonCard__ability-description">
            (se("Redirects single-target electric moves to this Pokémon where possible.  Absorbs Electric moves, raising Special Attack one stage"))
            </p>
          </div>
        </div>
      </section>
      <div className="ps-PokemonCard__bar"></div>
    </article>
};
